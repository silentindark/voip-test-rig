-- Minimal Kamailio schema for this rig: version bookkeeping + auth (subscriber)
-- + user location. Reused verbatim from the canonical kamctl MySQL schemas
-- (utils/kamctl/mysql/{auth_db,usrloc}-create.sql in the Kamailio source tree).
-- Auto-loaded by the mysql container on first boot.
...
CREATE TABLE `version` (
    ...
    `table_version` INT(10) UNSIGNED DEFAULT 0 NOT NULL,
